/**
 * Design-sync TYPES entry. Exports only the 48 top-level components that get
 * preview cards — this drives component discovery and prop-contract extraction.
 * The JS bundle (ds-entry.tsx) still exports every sub-component for preview
 * composition; this file only narrows which components become cards.
 * Generated for /design-sync — not imported by the app.
 */
